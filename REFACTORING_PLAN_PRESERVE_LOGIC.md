...
### **🎯 Назначение файла:**
- `temp.md` - **только для текущего этапа**
- Описывает что делаем **сейчас**
- **Полностью переписывается** на каждом этапе
...
5. **Следующий этап** - очищаем temp.md, описываем новый этап
